...
export default function ProfileSelector({ onSearch, isLoading = false }) {
    ...
    <section className="rounded-2xl border border-border bg-surface p-4 sm:p-5 md:p-6">
      <div className="mb-4">
        ...
        <p className="mt-1 text-sm text-text-secondary">
          Select batch and enter roll number to fetch student profile.
        </p>
      </div>
